  ...
  return (
    <div>
        <a className='relative group' target='_blank' href= {link}>
            <div className='overlay absolute top-0 rounded-xl left-0 w-full h-full bg-[#6aa5e9] bg-opacity-0 hidden group-hover:flex  group-hover:bg-opacity-80 transition-all duration-300'> 
