  ...
  return (
    <main className="flex min-h-screen flex-col bg-[url('./images/pillars.jpg')] bg-cover ">
      ...
      <div className = "container mt-20 mx-auto px-12 py-4">
        ...
        <Description/>
        <div className= "h-60 md:h-20"></div>
        <div className=" md:hidden animate-bounce container flex justify-center"> <ChevronDoubleDownIcon className="h-6 y-6"/> </div>
        <div id = "aboutme" className= "h-40 md:h-29"></div>
        </Fade>
